...
local UserName = (data.username_ or "UU_SD1")
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌕 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_SD1')..') \n 🌕 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "بكار")
...
send(msg.chat_id_,0," 🌕 الـعـضو  : {["..data.first_name_.."](T.ME/UU_SD1)}\n 🌕 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🌕 عذرا  ↚ {["..data.first_name_.."](T.ME/UU_SD1)}\n 🌕 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'مالك السورس' or text == 'بطوط' then
local Text = [[
[بطوط مالك السورس](t.me/ba_to_t
)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹B A T O T˼',url="t.me/ba_to_t"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'مطور السورس' or text == 'حمو' then
local Text = [[
[حمو مطور السورس](t.me/H_1_0O)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹H A M O˼',url="t.me/H_1_0O"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, '🌕  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_SD1')..') \n🌕 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌕 تم تعطيل جلب الصوره \n 🌕 تم قفل البوتات  \n 🌕 تم قفل التكرار ،\n 🌕 تم قفل الروابط ،\n 🌕 تم قفل التوجيه ،\n 🌕 تم قفل الملصقات ،\n 🌕 تم قفل المتحركه ،\n 🌕 تم قفل الفيديو ،\n 🌕 تم قفل الفشار ،\n 🌕 تم قفل الانلاين ،\n 🌕 تم قفل تعديل المديا ،\n 🌕 تم وضع التكرار  ،\n 🌕 تم قفل الفارسيه  ،\n 🌕 تم وضع الايدي بدون صوره ،n  \n 🌕 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_SD1')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'UU_SD1')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🌕  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UU_SD1')..') \n 🌕 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1831228999) then  
...
if result.id_ == tonumber(1831228999) then
...
if tonumber(userid) == tonumber(1831228999) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مالك السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_," 🌕 عذرا الملف لايدعم سورس بكار\n") 
end
return false
end
...
if text == ("مسح قائمه بكار") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🌕 تم مسح قائمه بكار')
return false
end

if text == 'قائمه بكار' and Sudo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🌕 لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SD1')..')'
status  = '\n 🌕 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🌕 الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🌕 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SD1')..')'
...
send(msg.chat_id_, msg.id_, t..'≪━━━━☩𝑩𝑨𝑲𝑨𝑹☩━━━━≫\nاضغط علي الاسم ليتم نسخه\n≪━━━━☩𝑩𝑨𝑲𝑨𝑹☩━━━━≫ٴ\n 🌕 ❲[𝑩𝑨𝑲𝑨𝑹](t.me/UU_SD1)❳ 🌕 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🌕 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'UU_SD1')..')'..'\n 🌕 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SD1')..') '
...
end --الكود حصري سورس بكاريعني لو بكتهن راح اعرفك انت الاخذتهن
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/UU_SD1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
{
{text = 'ااوامر اصحاب الرتب ⇊', callback_data="/help2"},{text = 'اوامر الحمايه ⇊', callback_data="/homelocks"},
},
{
{text = '˹𝑪𝑯˼ ', url="t.me/UU_SD1"},
},
...
redis:set(bot_id..'DRAGON:ChekiDRG:Seted'..Chat_id,'true')
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'DRAGON:ChekiDRG:Kick:Me:Group'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'DRAGON:ChekiDRG:Seted'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'DRAGON:ChekiDRG:Kick:Me:Group'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/lockeDRGlish' and Mod(data) then
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Textedit)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
elseif Text == '/unlockeDRGlish' and Mod(data) then
...
{
{text = 'قفل الانجليزيه', callback_data="/lockeDRGlish"},{text = 'فتح الانجليزيه', callback_data="/unlockeDRGlish"},
},
{
