...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹H A M O˼',url="t.me/HaMoO201"}},
{{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(122122111122) then  
send(msg.chat_id_, msg.id_, " 🦂 ده بابا عيب")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(12211122) then  
...
if tonumber(result.sender_user_id_) == tonumber(123123123) then  
...
if tonumber(result.id_) == tonumber(12211122) then
send(msg.chat_id_, msg.id_, " 🦂 لا يمكنك حظر مطور السورس\n")
return false 
end
if tonumber(result.id_) == tonumber(122122111122) then  
...
if tonumber(result.id_) == tonumber(123123123) then
...
if tonumber(userid) == tonumber(12211122) then  
send(msg.chat_id_, msg.id_, " 🦂 لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(122122111122) then  
send(msg.chat_id_, msg.id_, " 🦂 ده بابا عيب")
return false 
end
...
if tonumber(userid) == tonumber(123123123) then  
send(msg.chat_id_, msg.id_, " 🦂 لا تسطيع حظر مالك السورس عام")
return false 
end
